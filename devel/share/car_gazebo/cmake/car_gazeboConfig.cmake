...
if("TRUE" STREQUAL "TRUE")
  set(car_gazebo_SOURCE_PREFIX /home/danieloche/Documents/ROS_code/src/car_gazebo)
  set(car_gazebo_DEVEL_PREFIX /home/danieloche/Documents/ROS_code/devel)
  ...
  set(car_gazebo_INSTALL_PREFIX /home/danieloche/Documents/ROS_code/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'car_gazebo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'danieloche <adaspl@bde.enseeiht.fr>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'car_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/danieloche/Documents/ROS_code/src/car_gazebo/${idir}'.  Ask the maintainer 'danieloche <adaspl@bde.enseeiht.fr>' to fix it.")
    endif()
