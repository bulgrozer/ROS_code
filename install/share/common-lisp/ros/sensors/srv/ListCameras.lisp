...
(cl:defmethod cl:initialize-instance :after ((m <ListCameras-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListCameras-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensors-srv:<ListCameras-request> is deprecated: use sensors-srv:ListCameras-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ListCameras-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListCameras-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensors-srv:<ListCameras-response> is deprecated: use sensors-srv:ListCameras-response instead.")))

(cl:ensure-generic-function 'cameras-val :lambda-list '(m))
(cl:defmethod cameras-val ((m <ListCameras-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensors-srv:cameras-val is deprecated.  Use sensors-srv:cameras instead.")
  (cameras m))
